	...
	<div class="mx-auto max-w-7xl px-4 sm:px-6">
	  <div class="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
		...
		<nav class="hidden space-x-10 md:flex">
		  ...
		  <a href="/team" class="text-base font-medium text-gray-500 hover:text-gray-900">Meet the Team</a>
		  <a href="/research" class="text-base font-medium text-gray-500 hover:text-gray-900">Research</a>
		  <a href="/art" class="text-base font-medium text-gray-500 hover:text-gray-900">Connecting Cultures</a>
